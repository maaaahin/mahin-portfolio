...
const about = {
    title: "About me",
    description: "Fueled by Curiosity, Driven by Code",
    info: [
        {
            fieldName: "Name",
            fieldValue: "Mahin Chandwani",
        },
        {
            fieldName: "Phone",
            fieldValue: "+91-742605421",
        },
        ...
        {
            fieldName: "Email",
            fieldValue: "mahinchandwani2@gmail.com",
        },
        {
            fieldName: "Languages",
        ...
        {
            fieldName: "Hobbies",
            fieldValue: "Playing Guitar, Dancing, Lifting Weights",
        },
    ]
}
...
const certificates = {
    ...
    description: "Certifications That Validate My Skills",
    items: [
        {
...
const education = {
    ...
    title: "My education",
    description: "Academics That Define My Pathway",
    items: [
        {
        ...
        {
            institution : "St. Edmund's School, Malviya Nagar, Jaipur",
            degree : "12th-PCM",
            duration : "2019 - 2021",
        },
        {
...
const skills = {
    title: "My skills",
    description: "Crafting Solutions with These Technologies...",
    skillList: [
        {
            icon: <FaJava/>,
            name: "java",

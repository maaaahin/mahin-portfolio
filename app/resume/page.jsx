...
const about = {
    title: "About me",
    description: "weiufweifbwe wefygweifbwebf ewfweyigfwefg",
    info: [
        {
            fieldName: "Name",
...
const experience = {
    ...
    title: "My experience",
    description: "fewfb ewfewfbwei wefygwefvwelh fwe fywegfew",
    items: [
        {
...
const skills = {
    title: "My skills",
    description: "dwd egyebfuw efgwefyweuf ewfgyewfuywef",
    skillList: [
        {
            icon: <FaHtml5/>,
            name: "html 5",
